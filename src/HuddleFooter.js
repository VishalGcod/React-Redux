...
import Mock from "./imageSvgPngs/mockups.svg";
import {
  Button3,
  DivAbsolute,
  Footer,
    ...
    <div>
      ...
      <Footer>
        <FooterDiv1>
          ...
          <p>
            <ContactImages src={phoneImg} alt="phonelogo"></ContactImages>{" "}
            +1-543-123-4567
          </p>
          <p>
            <ContactImages src={emailIcon} alt="emaillogo"></ContactImages>{" "}
            example@huddle.com
          </p>
        </FooterDiv1>
        <FooterDiv2>
